...
axs.semilogx(f, phase1, linewidth=3, label='proposed')
axs.semilogx(f, phase1_icnirp, 'k--', label='ICNIRP')
...
axs.semilogx(f, phase2, linewidth=3, label='proposed')
axs.semilogx(f, phase2_icnirp, 'k--', label='ICNIRP')
axs.set_xticks((ft*0.1, ft, ft*10))
axs.set_xticklabels(("$0.1 f_j$", "$f_j$", "$10 f_j$"), fontsize=16)
axs.set_ylim(-200,200)
...
# fig3.savefig("./img/real_zero.png", dpi=300)
# fig4.savefig("./img/real_pole.png", dpi=300)
